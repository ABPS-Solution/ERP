...
async function handleIcfFormatTypeChange(typeOfMaterial) {
  ...
  // Templates use this app's own "<A or B>" placeholder syntax — interpolated
  // raw into innerHTML, a placeholder like "<SVG nph kVAr or AHF nph A>" gets
  // parsed by the browser as a real <svg> element and swallows everything
  // after it into foreign-content parsing, producing large blank gaps.
  // Escape before display (same fix as Portal's item-codes.js).

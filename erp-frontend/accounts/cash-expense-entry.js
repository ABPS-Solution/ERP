...
// was actually spent and reconciles the difference back into the
// balance. Ported from ABPS Portal (31 Aug 2026).
...
async function initializeCashExpenseEntryPanel() {
  ...
  try {
    const data = await apFetch({ action: "searchCashExpenseEmployees" });

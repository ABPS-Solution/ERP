...
// sibling file. "Daily Advance" hands money to an employee immediately;
// "Daily Expense Vouchers" closes that advance out once the actual spend
// is known — see cash-expense-vouchers.js. Ported from ABPS Portal
// (31 Aug 2026). formatINRComma moved to shared/format.js (ERP-only
// change — Portal duplicates it in this file and tour-shell.js).

const CASH_EXPENSE_TOGGLES = ["expenses", "vouchers", "balance", "search", "employees"];

// Mirrors erp-backend's cash expenses routes' EXPENSE_TYPES /
...
// it's visible no matter which toggle is open — not just the "Add to Cash
// Box" panel. Fetched once on load and refreshed whenever cash-balance.js's
// own load/topup flow re-fetches the balance.

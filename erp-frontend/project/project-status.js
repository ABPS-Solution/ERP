...
// initializeProjectStatusPanel/exitProjectStatusBackToMenu — in Portal
// these are misplaced (initializeProjectStatusPanel actually lives in
// shared/typeahead.js, exitProjectStatusBackToMenu in
// design/item-codes.js — an artifact of Portal's automated department
// split; found by grepping for their real declaration site, per this
// port's own working rule). Declared here instead, in this screen's
// actual owner file, rather than perpetuating the misplacement — same
// precedent as marketing-dashboard.js's mdCurrentPeriod fix in this same
// migration. This file previously (wrongly) carried four OTHER screens'
// exit functions (exitTourExpenseBackToMenu/exitCashExpensesBackToMenu/
// exitTravelTicketsBackToMenu/exitDesignWorkspacePanelBackToMenu) copied
// verbatim from Portal's own misplaced copies — removed, since ERP
// already has its own correct versions of all four (accounts/*.js,
// design/design-dashboard.js); redeclaring them here would just be dead
// weight, not a fix.

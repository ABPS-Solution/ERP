...
function dtlToday() {
  // ptlToday() already handles the admin erpPtlTodayOverride localStorage key
...
function dtlTodayOverrideValue() {
  return (typeof ptlIsAdmin === 'function' && ptlIsAdmin()) ? localStorage.getItem('erpPtlTodayOverride') : null;
}

...
// filtered.
//
// Ported from Portal byte-for-byte (Batch 9, 16 Sep 2026) apart from this
// note — it needs only apFetch / escapeHtml / userPermissions /
// enforceDynamicModuleRoleGateways, all of which already exist in ERP
// under the same names, and it writes no localStorage key (so CLAUDE.md
// §3's erp-prefix rule doesn't apply here).
// ═══════════════════════════════════════════════════════════════════════

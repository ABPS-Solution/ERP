// ═══════════════════════════════════════════════════════════════════════
// shared/drafts.js — ported verbatim from ABPS Portal (Batch 4, Design).
// ONE adaptation, per ERP CLAUDE.md §3: the localStorage key prefix is
// "erpAbpsDraft:" not Portal's "abpsDraft:" — Portal and ERP are the SAME
// browser origin (abps-solution.github.io, different path only), so an
// unprefixed key would collide with Portal's own drafts. The matching
// prefix sweep lives in clearAppLocalStorageKeepingDeviceKeys
// (shared/apFetch.js) — change both together.
// ═══════════════════════════════════════════════════════════════════════
// ═══════════════════════════════════════════════════════════════════════
...
const ABPS_DRAFT_PREFIX = "erpAbpsDraft:";

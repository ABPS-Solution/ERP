...
function renderMaterialListByType(materials) {
  ...
  Object.keys(typeGroups).sort().forEach(type => {
    ...
    const isCollapsed = localStorage.getItem("erp_ml_section_" + type) === "collapsed";
    ...
    headerDiv.onclick = () => {
      ...
      if (body.style.display === "none") {
        ...
        localStorage.setItem("erp_ml_section_" + type, "expanded");
      } else {
        body.style.display = "none";
        btn.textContent = "▼ Expand";
        localStorage.setItem("erp_ml_section_" + type, "collapsed");
      }
    };
    headerDiv.innerHTML = `

...
// same-named file — see that file's own header for the full design
// rationale. Tracks expected-vs-received payment tranches per customer
...
// exitOrderPaymentBackToMenu — ERP's own convention: each screen defines
// its own exit function in its own file, unlike Portal which centralizes
// these in shared/navigation.js (see e.g. project/project-status.js's
// exitProjectStatusBackToMenu for the same pattern).

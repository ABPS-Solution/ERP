...
function renderRawMaterialsStockGrid() {
...

  {
      ...
      sortedTypes.forEach(type => {
        ...
        const isCollapsed = localStorage.getItem("erp_rm_section_" + type) === "collapsed";
        ...
        headerDiv.onclick = () => {
          ...
          if (body.style.display === "none") {
            ...
            localStorage.setItem("erp_rm_section_" + type, "expanded");
          } else {
            body.style.display = "none";
            btn.textContent = "▼ Expand";
            localStorage.setItem("erp_rm_section_" + type, "collapsed");
          }
        };
        headerDiv.innerHTML = `
...
function renderSpareStoreStockGrid() {
...

  {
    ...
    Object.keys(typeGroups).sort().forEach(type => {
      ...
      const isCollapsed = localStorage.getItem("erp_spare_section_" + type) === "collapsed";
      ...
      headerDiv.onclick = () => {
        ...
        if (body.style.display === "none") {
          body.style.display = "flex";
          btn.textContent = "▲ Collapse";
          localStorage.setItem("erp_spare_section_" + type, "expanded");
        } else {
          body.style.display = "none";
          btn.textContent = "▼ Expand";
          localStorage.setItem("erp_spare_section_" + type, "collapsed");
        }
      };
      headerDiv.innerHTML = `
        <div style="display:flex; align-items:center; gap:10px;">

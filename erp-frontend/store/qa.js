      ...
      <table class="mobile-scroll-table" style="width:100%; border-collapse:collapse; table-layout:fixed;">
        <thead>
          <tr style="background:#f8fafc; border-bottom:2px solid var(--border);">
            ...
            <th style="width:8%; padding:6px 4px; text-align:center; font-size:0.72rem; text-transform:uppercase; color:var(--muted); ${headerColBorder}">Mode</th>
            ...
            <th style="width:9.5%; padding:6px 4px; text-align:left; font-size:0.72rem; text-transform:uppercase; color:var(--muted); ${headerColBorder}">Objection Raised</th>

// ═══════════════════════════════════════════════════════════════════════
// production/job-cards.js — ported in Batch 6 (Store, 16 Sep 2026), NOT
// Batch 7.
//
// Despite its Production-department path this file is entirely Create
// Material Issue Ticket helpers — updateSelectedLiveStockPillCounter
// (the live stock + Job Card allotment pill) and
// handleCreateTicketProjectChange (the Project -> Store Scope -> BOQ ->
// Job Card cascade). Both are called from store/tickets.js and from the
// Create Material Issue Ticket panel markup, so they had to come across
// with Store. This is Portal'''s COMPLETE file, not an extract — Batch 7
// (Production) should leave it alone; its own screens live in
// production/job-card-sheet.js, production-planning.js, etc.
//
// Portal'''s own ~130-line dead Job Card creation screen was deleted from
// this file on 3 Sep 2026, so there is nothing else here to port.
// ═══════════════════════════════════════════════════════════════════════
